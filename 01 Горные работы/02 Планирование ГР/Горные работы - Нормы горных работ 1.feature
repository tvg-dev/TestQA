...
И из выпадающего списка с именем "СсылкаОрганизация" я выбираю точное значение 'Разрез "Полевой"'
...
И в таблице "Список" я выбираю текущую строку
Тогда открылось окно 'Установка норм горных работ (создание) *'
И в таблице "Нормы" я активизирую поле с именем "НормыАналитикаОборудования"
...
И в таблице "Список" я перехожу к строке:
	...
	| '000000002' | 'Komatsu PC-400-7' | 'Экскаваторы'            |
И в таблице "Список" я выбираю текущую строку
Тогда открылось окно 'Аналитики оборудования'
...
И в таблице "Список" я перехожу к строке:
	| 'Код'       | 'Наименование' | 'Технологическая группа'    |
	| '000000005' | 'Белаз 7545'   | 'Технологический транспорт' |
И в таблице "Список" я выбираю текущую строку
Тогда открылось окно 'Аналитики оборудования'
И я нажимаю на кнопку с именем 'ОК'
Когда открылось окно 'Установка норм горных работ (создание) *'
И в таблице "Нормы" я активизирую поле с именем "НормыАналитикаМестаРаботы"
...
И в таблице "Список" я выбираю текущую строку
Тогда открылось окно 'Аналитики места работ'
И из выпадающего списка с именем "Горизонт" я выбираю точное значение 'Горизонт 100'
...
И я нажимаю на кнопку с именем 'ОК'
Тогда открылось окно 'Установка норм горных работ (создание) *'
И в таблице "Нормы" я активизирую поле с именем "НормыНоменклатура"
...
Тогда открылось окно 'Установка норм горных работ (создание) *'
И в таблице "Нормы" я активизирую поле с именем "НормыХарактеристика"
...
И в таблице "Список" я выбираю текущую строку
Тогда открылось окно 'Установка норм горных работ (создание) *'
И в таблице "Нормы" я активизирую поле с именем "НормыКоличество"
И в таблице "Нормы" в поле с именем 'НормыКоличество' я ввожу текст '120 000,000'
И в таблице "Нормы" я активизирую поле с именем "НормыУпаковка"
